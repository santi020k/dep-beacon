...
const extensionRoot = resolve(packageRoot, '../../extensions/dep-beacon-lsp')
...
const syncCargoLockVersion = () => {
  ...
  if (!packagePattern.test(source)) throw new Error(`Could not find dep-beacon-lsp in ${cargoLockPath}.`)
